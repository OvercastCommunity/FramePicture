...
public class FramePictureCommand implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
    ...
    try {
      Method method =
          FramePictureCommand.class.getDeclaredMethod(
              methodName, CommandSender.class, String[].class);
  ...
  public boolean sendHelp(CommandSender sender) {
    ...
    sender.sendMessage(
        "/FramePicture set <URL>  "
            ...
            + "--"
            + ChatColor.WHITE
            + "  Set a Picture in a Frame.");
    sender.sendMessage(
        "/FramePicture multiset <URL>  "
            + ChatColor.GOLD
            + "--"
            + ChatColor.WHITE
